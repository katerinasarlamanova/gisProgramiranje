...
project = u'Frames'
copyright = u'2013, Katerina Sharlamanova'
...
latex_documents = [
  ('index', 'Frames.tex', u'Frames Documentation',
   u'Katerina Sharlamanova', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'Frames Documentation',
     [u'Katerina Sharlamanova'], 1)
]
