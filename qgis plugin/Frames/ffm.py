...
class Frames:
    ...
    def currentTime(self):            # frame at a current time
        ...
        if success:
            ...
            cv2.imwrite(imagesFolder + "/image_%d.jpg" % x, image)   # save frame as JPEG file
    ...
    def everySecond(self):            # frames at every second
        videoFile = self.file         # self.file is defined in function video()
        imagesFolder = self.tempdir   # self.tempdir is defined in function directory()
